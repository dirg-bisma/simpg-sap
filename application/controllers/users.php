	...
	function grids(){
		...
		foreach ($rows as $dt) {
            ...
            if($this->access['is_detail'] ==1){
            	$btn .= '<a href='.site_url('users/show/'.$dt->id).'  class="tips "  title="view"><i class="fa  fa-search"></i>  </a> &nbsp;&nbsp;';
            }
            if($this->access['is_edit'] ==1){
            	$btn .= '<a href='.site_url('users/add/'.$dt->id).'  class="tips "  title="Edit"><i class="fa  fa-edit"></i>  </a> &nbsp;&nbsp;';
            }
            if($this->access['is_remove'] ==1){
            	$btn .= '<a href="#" onclick="ConfirmDelete(\''.site_url('users/destroy/').'\','.$dt->id.')"  class="tips "  title="Delete"><i class="fa  fa-trash"></i>  </a>';
