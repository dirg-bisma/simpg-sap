    ...
    public function saveExcelEvaluasi()
    {
		...
		$highestColumn = $sheet->getHighestColumn();
			...
			$arr_evaluasi = array(
					...
					"TEBU_SENDIRI_LUAS_HA_RKAP" => $sheet->getCell('IE11')->getCalculatedValue(),
					"TEBU_PETANI_LUAS_HA_RKAP" => $sheet->getCell('IE12')->getCalculatedValue(),
					"JUMLAH_LUAS_HA_RKAP" => $sheet->getCell('IE13')->getCalculatedValue(),
					"TEBU_SENDIRI_TEBU_DIGILING_TON_RKAP" => $sheet->getCell('IE15')->getCalculatedValue(),
					"TEBU_PETANI_TEBU_DIGILING_TON_RKAP" => $sheet->getCell('IE16')->getCalculatedValue(),
					"JUMLAH_TEBU_DIGILING_TON_RKAP" => $sheet->getCell('IE17')->getCalculatedValue(),
					"TEBU_SENDIRI_HABLUR_HASILTON_RKAP" => $sheet->getCell('IE19')->getCalculatedValue(),
					"TEBU_PETANI_HABLUR_HASILTON_RKAP" => $sheet->getCell('IE20')->getCalculatedValue(),
					"JUMLAH_HABLUR_HASILTON_RKAP" => $sheet->getCell('IE21')->getCalculatedValue(),
					"TEBU_SENDIRI_RENDEMEN_RKAP" => $sheet->getCell('IE23')->getCalculatedValue(),
					"TEBU_PETANI_RENDEMEN_RKAP" => $sheet->getCell('IE24')->getCalculatedValue(),
					"JUMLAH_RENDEMEN_RKAP" => $sheet->getCell('IE25')->getCalculatedValue(),
					"TEBU_SENDIRI_PRODUKTIVITAS_TON_TEBUHA_RKAP" => $sheet->getCell('IE27')->getCalculatedValue(),
					"TEBU_PETANI_PRODUKTIVITAS_TON_TEBUHA_RKAP" => $sheet->getCell('IE28')->getCalculatedValue(),
					"JUMLAH_PRODUKTIVITAS_TON_TEBUHA_RKAP" => $sheet->getCell('IE29')->getCalculatedValue(),
					"TEBU_SENDIRI_HABLUR__HA_TONHA_RKAP" => $sheet->getCell('IE31')->getCalculatedValue(),
					"TEBU_PETANI_HABLUR__HA_TONHA_RKAP" => $sheet->getCell('IE32')->getCalculatedValue(),
					"JUMLAH_HABLUR__HA_TONHA_RKAP" => $sheet->getCell('IE33')->getCalculatedValue(),
					"MILIK_PG_HABLUR_MILIK_TON_RKAP" => $sheet->getCell('IE35')->getCalculatedValue(),
					"MILIK_PETANI_HABLUR_MILIK_TON_RKAP" => $sheet->getCell('IE36')->getCalculatedValue(),
					"JUMLAH_HABLUR_MILIK_TON_RKAP" => $sheet->getCell('IE37')->getCalculatedValue(),
					"MILIK_PG_GULA_MILIK_RKAP" => $sheet->getCell('IE39')->getCalculatedValue(),
					"MILIK_PETANI_GULA_MILIK_RKAP" => $sheet->getCell('IE40')->getCalculatedValue(),
					"JUMLAH_GULA_MILIK_RKAP" => $sheet->getCell('IE41')->getCalculatedValue(),
					"MILIK_PG_PRODUKSI_TETES_TON_RKAP" => $sheet->getCell('IE43')->getCalculatedValue(),
					"MILIK_PETANI_PRODUKSI_TETES_TON_RKAP" => $sheet->getCell('IE44')->getCalculatedValue(),
					"JUMLAH_PRODUKSI_TETES_TON_RKAP" => $sheet->getCell('IE45')->getCalculatedValue(),
					"PERSEN_POL_TEBU_RKAP" => $sheet->getCell('IE46')->getCalculatedValue(),
					"PERSEN_BRIX_TEBU_RKAP" => $sheet->getCell('IE47')->getCalculatedValue(),
					"NILAI_NIRA_RKAP" => $sheet->getCell('IE48')->getCalculatedValue(),
					"KADAR_NIRA_TEBU_RKAP" => $sheet->getCell('IE49')->getCalculatedValue(),
					"KECGILING_EXCL_TON_RKAP" => $sheet->getCell('IE51')->getCalculatedValue(),
					"KECGILING_INCL_TANPA_HARI_RAYA_TON_RKAP" => $sheet->getCell('IE52')->getCalculatedValue(),
					"KECGILING_INCL_HARI_RAYA_TON_RKAP" => $sheet->getCell('IE53')->getCalculatedValue(),
					"PERSEN_JAM_BERHENTI_A_TANPA_HARI_RAYA_LUAR_RKAP" => $sheet->getCell('IE54')->getCalculatedValue(),
					"PERSEN_JAM_BERHENTI_A_DENGAN_HARI_RAYA_LUAR_RKAP" => $sheet->getCell('IE55')->getCalculatedValue(),
					"PERSEN_JAM_BERHENTI_BDALAM_RKAP" => $sheet->getCell('IE56')->getCalculatedValue(),
					"JAM_BERHENTI_PERSEN_JAM_GILING_RKAP" => $sheet->getCell('IE57')->getCalculatedValue(),
					"NIRA_MENTAH_PERSEN_TEBU_RKAP" => $sheet->getCell('IE58')->getCalculatedValue(),
					"IMBIBISI_PERSEN_SABUT_RKAP" => $sheet->getCell('IE59')->getCalculatedValue(),
					"HPB_I_RKAP" => $sheet->getCell('IE60')->getCalculatedValue(),
					"HPB_TOTAL_RKAP" => $sheet->getCell('IE61')->getCalculatedValue(),
					"HPG_RKAP" => $sheet->getCell('IE62')->getCalculatedValue(),
					"HPG_125_RKAP" => $sheet->getCell('IE63')->getCalculatedValue(),
					"POL_AMPAS_RKAP" => $sheet->getCell('IE64')->getCalculatedValue(),
					"PERSEN_BAHAN_KERING_AMPAS_RKAP" => $sheet->getCell('IE65')->getCalculatedValue(),
					"SABUT_PERSEN_TEBU_RKAP" => $sheet->getCell('IE66')->getCalculatedValue(),
					"PSHK_RKAP" => $sheet->getCell('IE67')->getCalculatedValue(),
					"NIRA_ASLI_HILANG_PERSEN_SABUT_RKAP" => $sheet->getCell('IE68')->getCalculatedValue(),
					"EFISIENSI_GILINGAN_RKAP" => $sheet->getCell('IE69')->getCalculatedValue(),
					"POL_BLOTONG_RKAP" => $sheet->getCell('IE71')->getCalculatedValue(),
					"PENGASINGAN_BUKAN_GULA_RKAP" => $sheet->getCell('IE72')->getCalculatedValue(),
					"KG_AIR_DIUAPKANM2_LPJBP_RKAP" => $sheet->getCell('IE73')->getCalculatedValue(),
					"KEHILANGAN_POL_PERSEN_POL_NM_RKAP" => $sheet->getCell('IE74')->getCalculatedValue(),
					"WINTER_RENDEMEN_RKAP" => $sheet->getCell('IE75')->getCalculatedValue(),
					"BHR__RKAP" => $sheet->getCell('IE76')->getCalculatedValue(),
					"POL_HASIL_PERSEN_POL_NIRA_MENTAH_RKAP" => $sheet->getCell('IE77')->getCalculatedValue(),
					"POL_HILANG_DALAM_AMPAS_RKAP" => $sheet->getCell('IE78')->getCalculatedValue(),
					"POL_HILANG_DALAM_BLOTONG_RKAP" => $sheet->getCell('IE79')->getCalculatedValue(),
					"POL_HILANG_DALAM_TETES_RKAP" => $sheet->getCell('IE80')->getCalculatedValue(),
					"POL_HILANG_TAK_DIKETAHUI_OV_RKAP" => $sheet->getCell('IE81')->getCalculatedValue(),
					"TOTAL_KEHILANGAN_RKAP" => $sheet->getCell('IE82')->getCalculatedValue(),
					"EFFISIENSI_PABRIK_RKAP" => $sheet->getCell('IE84')->getCalculatedValue(),
					"OVERALL_RECOVERY_RKAP" => $sheet->getCell('IE85')->getCalculatedValue(),
					"FAKTOR_RENDEMEN_RKAP" => $sheet->getCell('IE86')->getCalculatedValue(),
					"RENDEMEN_EFEKTIF_RKAP" => $sheet->getCell('IE87')->getCalculatedValue(),
					"HK_NIRA_MENTAH_RKAP" => $sheet->getCell('IE88')->getCalculatedValue(),
					"KEHIL_POL_PERSEN_POL_NM_RKAP" => $sheet->getCell('IE89')->getCalculatedValue(),
					"KAPUR_KG_RKAP" => $sheet->getCell('IE91')->getCalculatedValue(),
					"KAPUR__100_TON_TEBU_RKAP" => $sheet->getCell('IE92')->getCalculatedValue(),
					"BELERANG_KG_RKAP" => $sheet->getCell('IE93')->getCalculatedValue(),
					"BELERANG__100_TON_TEBU_RKAP" => $sheet->getCell('IE94')->getCalculatedValue(),
					"ASAM_PHOSPHAT_KG_RKAP" => $sheet->getCell('IE95')->getCalculatedValue(),
					"ASAM_PHOSPHAT__100_TON_TEBU_RKAP" => $sheet->getCell('IE96')->getCalculatedValue(),
					"FLOCULANT_KG_RKAP" => $sheet->getCell('IE97')->getCalculatedValue(),
					"FLOCULANT__100_TON_TEBU_RKAP" => $sheet->getCell('IE98')->getCalculatedValue(),
					"FILTER_AID_KG_RKAP" => $sheet->getCell('IE99')->getCalculatedValue(),
