...
LEFT JOIN sap_petani d ON d.`id_petani_sap`=c.`id_petani_sap` WHERE 0=0 AND cetak_spta_status=0 $wh")->result();
		$html = '';$i=1;
		foreach($a as $b){
			$this->data['row'] =$b; 
