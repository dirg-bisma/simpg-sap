...
//		echo $id;die();
 ...
 WHERE TABLE_SCHEMA = SCHEMA()
  ...
  PRIMARY KEY (`id`)
   ...
   t_timbangan,t_upah_tebang,t_upah_tebang_detail,sap_field,sap_field_spt,m_vendor,sap_m_affdeling,sap_m_karyawan,sap_m_petani,sap_petani,sap_plant,m_lori,m_tara_truk";
   $rx = explode(',', $r);
