...
/*
    ...
    function ambildata(){
    	$sql1 = $this->db->query("SELECT IF(LEFT(b.`kepemilikan`,5) = 'TS-ST','TS',IF(LEFT(b.`kepemilikan`,5) = 'TS-SP','TR',LEFT(b.`kepemilikan`,2))) AS kode,kode_plant_trasnfer,SUM(c.`ha_tertebang`) AS ha, 
