                        ...
                        <form action="<?php echo site_url('tanalisarendemen/save/'); ?>" class='form-vertical'
                            ...
                            <div class="col-md-6">
                                <div class="form-group col-md-12 " >
                                    ...
                                    <input type='number' class='form-control input-sm'  name='faktor_rendemen' value=""  />
                                </div>
                                ...
                                if(CNF_METODE == 2){
                                    ...
                                    <div class="form-group col-md-8	 " >
                                        ...
                                        <textarea name='ditolak_alasan' rows='1' id='ditolak_alasan' class='form-control input-sm '></textarea>
                                    </div>
                                    <?php
                                }
                                ?>
