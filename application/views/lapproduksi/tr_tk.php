...
<?php foreach($plant_trans as $row_trans){?>
    <tr>
        ...
        <input type="hidden" name="trans_kode_kat_lahan_<?php echo replaceKat("TR-TK")."_".$row_trans->kode_plant_trasnfer;?>" value="TR-TK">
        <input type="hidden" name="trans_kat_ptpn_<?php echo replaceKat("TR-TK")."_".$row_trans->kode_plant_trasnfer;?>" value="TR-TK">
        <input type="hidden" name="trans_kat_kepemilikan_<?php echo replaceKat("TR-TK")."_".$row_trans->kode_plant_trasnfer;?>" value="TR">
