                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <?php if($this->access['is_add'] ==1) : ?>
                            <a href="<?php echo site_url('mlori/add') ?>" class="tips btn btn-xs btn-info"  title="<?php echo $this->lang->line('core.btn_new'); ?>">
                                <i class="fa fa-plus"></i>&nbsp;<?php echo $this->lang->line('core.btn_new'); ?> (F2) </a>
                        <?php endif;?>
                            <a href="<?php echo site_url('mlori/excel') ?>" class="tips btn btn-xs btn-danger"  title="Download">
...
<script>
    ...
    $(function () {
        ...
        table = $('#gridv').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('mlori/grids')?>",
                "type": "POST"
            },
