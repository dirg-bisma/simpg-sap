...
<td colspan="3" style="border:1px solid #00b8ff94">
        ...
        <td style="background-color: #00b8ff94;color: black;padding:5px">TON SHS SISA</td>
        <td style="background-color: #00b8ff94;color: black;padding:5px">TON TETES</td>
    ...
    <tr><td colspan="4">1. MILIK SENDIRI</td></tr>
        ...
        <tr style="background-color:pink;font-weight:bold;"><td style="color: black"><b> 
                TOTAL 1 + 2 + 3 </b></td>
                <td style="text-align: right;"><?=$kontrol->numberformat($extshablur,3);?></td>
                <td style="text-align: right;"><?=$kontrol->numberformat(round($extstonshs,2),3);?></td>
                <td style="text-align: right;"><?=$kontrol->numberformat($onsisa,3);?></td>
                <td style="text-align: right;"><?=$kontrol->numberformat($extstontetes,3);?></td>
            </tr>
            <tr style="background-color:pink;font-weight:bold;"><td style="color: black"><b> 
            ...
            <tr style="background-color:pink;font-weight:bold;"><td style="color: black"><b> 
                ...
                <td style="text-align: right;"><?=$kontrol->numberformat(round($extstonshs+$shsyll,2),3);?></td>
                <td style="text-align: right;"><?=$kontrol->numberformat(0,3);?></td>
