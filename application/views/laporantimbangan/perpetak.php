...
<th>NOMER PETAK</th><th>KEBUN</th><th>NAMA PETANI</th><th>KATEGORI</th><th>MANDOR</th><th>PTA</th><th>TRUK</th><th>LORI</th><th>ODONG2</th><th>TRAKTOR</th><th>HEKTAR</th><th>QTY TEBU</th><th>SISA HEKTAR</th><th>Tebu/Ha</th></tr></thead>
<tbody>
<?php
$truk = 0;
$lori = 0;
...
$tha = 0;
 foreach($result as $r){
	 echo '<tr><td> '.$r->kode_blok.' </td><td> '.$r->deskripsi_blok.' </td><td> '.$r->nama_petani.' </td><td> '.$r->kode_kat_lahan.'</td><td> '.$r->mandor.'</td><td> '.$r->pta.'</td><td align="center"> '.$r->truk.' </td><td align="center"> '.$r->lori.' </td><td align="center"> '.$r->odong2.' </td><td align="center"> '.$r->traktor.' </td><td align="right"> '.$r->tertebang.' </td><td align="right"> '.number_format($r->netto,0).' </td><td align="right"> '.$r->sisa.' </td><td align="right"> '.number_format($r->netto/$r->tertebang,0).' </td></tr>';
	 $truk += $r->truk;
	$lori += $r->lori;
	$odong2 += $r->odong2;
	$traktor += $r->traktor;
