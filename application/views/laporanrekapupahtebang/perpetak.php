...
PETAK <?=$titlepetak;?>
				...
				$bukti="";
					...
					foreach($detail as $d){
						...
						<th colspan="2"> JUMLAH BUKTI <?php echo $bukti;?></th>
					...
					<th style="text-align:right"><?php echo number_format($jbersih,2);?></th>
							...
							NO BUKTI <b style="color:white"><?php echo $d->no_bukti;?></b></td>
							<td colspan="2"> TGL <b style="color:white"><?php echo $d->tgl;?></b></td>
				...
				?>
					<tr style="background-color: #104E8B;color: white;">
						<th colspan="2" style="text-align:center"> JUMLAH NO BUKTI <?php echo $bukti;?></th>
						<th style="text-align:center"><?php echo $no;?> ANGKUTAN</th>
					<th style="text-align:right"><?php echo number_format($jnetto,2);?></th>
					<?php
						foreach($coldefadd as $kol1)
