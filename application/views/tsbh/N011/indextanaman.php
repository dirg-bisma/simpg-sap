...
<section class="content">
      ...
      switch ($gid) {
        ...
        case '11':
          ?>
              ...
              <li class="active"><a href="<?php echo site_url('tsbh/tanaman');?>"><i class="fa fa-check-circle"></i> Approve Tanaman </a></li>
          <?php
          break;
        case '12':
          ?>
    ...
    ?>
              ...
              <div class="box box-danger">
                  ...
                  <h3 class="box-title">Approve Tanaman</h3>
...
table = $('#gridv').DataTable({
          ...
          "ajax": {
            "url": "<?php echo site_url('tsbh/grids')?>/3/"+$('#tgl1').val()+'/'+$('#tgl2').val(),
            "type": "POST"
          }, 
...
function reloadGrid(){
       // $("#gridv").DataTable();
	   //table.destroy();
	   table.ajax.url( "<?php echo site_url('tsbh/grids')?>/3/"+$('#tgl1').val()+'/'+$('#tgl2').val() ).load();
 ...
 function approved(){
    ...
    type: "POST",
    data : {stt:2,cancel:0,tgl1:$('#tgl1').val(),tgl2:$('#tgl2').val()},
    beforeSend: function() {
 ...
 function cancelapproved(){
  $.ajax({
    url: "<?php echo site_url('tsbh/approved');?>",
    type: "POST",
    data : {stt:2,cancel:1,tgl1:$('#tgl1').val(),tgl2:$('#tgl2').val()},
    beforeSend: function() {
      return confirm("Apakah anda yakin approve data ini ?");
    },
    success: function(data){
