    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <ul class="nav nav-tabs" style="margin:10px 0;background:#dedede">
                <li class="active"><a href="<?php echo site_url('tsbh');?>"><i class="fa fa-download"></i> View & Download SBH </a></li>
                <?php
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#gridv').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('tsbh/grids')?>/0/"+$('#tgl1').val()+'/'+$('#tgl2').val(),
                "type": "POST"
            },
    ...
    function reloadGrid(){
        // $("#gridv").DataTable();
        //table.destroy();
        table.ajax.url( "<?php echo site_url('tsbh/grids')?>/0/"+$('#tgl1').val()+'/'+$('#tgl2').val() ).load();
