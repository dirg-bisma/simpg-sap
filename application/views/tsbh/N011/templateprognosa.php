...
<thead><tr class="tableizer-firstrow"><th>Jam</th><th>No SPTA</th><th>Tgl Giling</th><th>No Petak</th><th>Luas Ha</th><th>Luas Tertebang</th><th>Petani</th><th>Netto Tebu</th><th>Jenis SPTA</th><th>No Kendaraan</th><th>Kategori</th><th>Kualitas</th><th>Kristal Total</th><th>R. Total</th><th>R. Petani</th><th>Kristal Petani</th><th>Kristal PG</th><th>Gula Petani</th><th>Gula PG</th><th>Tetes Petani</th><th>Tetes PG</th></tr></thead>
<tbody>
<?php
foreach ($rows as $key) {
	?>
	<tr><td><?php echo $key->ari_tgl;?></td><td><?php echo $key->no_spat;?></td>
		<td><?php echo $key->tgl_giling;?></td>
