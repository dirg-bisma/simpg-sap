                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <?php if($this->access['is_add'] ==1) : ?>
                            <a href="<?php echo site_url('ajuantimbangan/add') ?>" class="tips btn btn-xs btn-info"  title="<?php echo $this->lang->line('core.btn_new'); ?>">
...
<script>
    ...
    $(function () {
        ...
        table = $('#gridv').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('ajuantimbangan/grids')?>",
                "type": "POST"
            },
