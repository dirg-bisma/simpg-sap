...
<section class="content">
		...
		<a href="<?php echo site_url('mjenistanah/add') ?>" class="tips btn btn-xs btn-info"  title="<?php echo $this->lang->line('core.btn_new'); ?>">
...
var table;
 $(function () {
       // $("#gridv").DataTable();
        ...
        "ajax": {
            "url": "<?php echo site_url('mjenistanah/grids')?>",
            "type": "POST"
        },
