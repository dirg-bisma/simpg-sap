...
<section class="content">
		...
		<a href="<?php echo site_url('tcancelselektor/add') ?>" class="tips btn btn-xs btn-info"  title="<?php echo $this->lang->line('core.btn_new'); ?>">
...
var table;
 $(function () {
       // $("#gridv").DataTable();
        ...
        "ajax": {
            "url": "<?php echo site_url('tcancelselektor/grids')?>",
            "type": "POST"
        },
